...
void setup()
{
  ...
  if (c == 0x68) // WHO_AM_I should always be 0x68
  {
    ...
    if (SelfTest[0] < 1.0f && SelfTest[1] < 1.0f && SelfTest[2] < 1.0f && SelfTest[3] < 1.0f && SelfTest[4] < 1.0f && SelfTest[5] < 1.0f) {
      //DX  display.clearDisplay();
      //DX display.setCursor(0, 30); display.print("Pass Selftest!");
      //DX  display.display();
      ...
      //DX  display.setCursor(20, 0); display.print("MPU6050 bias");
      //DX display.setCursor(0, 8); display.print(" x   y   z  ");

      //DX  display.setCursor(0,  16); display.print((int)(1000*accelBias[0]));
      //DX  display.setCursor(24, 16); display.print((int)(1000*accelBias[1]));
      //DX  display.setCursor(48, 16); display.print((int)(1000*accelBias[2]));
      //DX  display.setCursor(72, 16); display.print("mg");

      //DX  display.setCursor(0,  24); display.print(gyroBias[0], 1);
      //DX display.setCursor(24, 24); display.print(gyroBias[1], 1);
      //DX display.setCursor(48, 24); display.print(gyroBias[2], 1);
      //DX display.setCursor(66, 24); display.print("o/s");
...
void loop()
{
  ...
  if (delt_t > 5) { // update LCD once per half-second independent of read rate
    ...
    //DXdisplay.clearDisplay();

    //DXdisplay.setCursor(0, 0); display.print(" x   y   z  ");

    //DX display.setCursor(0,  8); display.print((int)(1000*ax));
    //DX  display.setCursor(24, 8); display.print((int)(1000*ay));
    //DX  display.setCursor(48, 8); display.print((int)(1000*az));
    //DX  display.setCursor(72, 8); display.print("mg");

    //DX   display.setCursor(0,  16); display.print((int)(gx));
    //DX  display.setCursor(24, 16); display.print((int)(gy));
    //DX  display.setCursor(48, 16); display.print((int)(gz));
    //DX  display.setCursor(66, 16); display.print("o/s");

    //DX  display.setCursor(0,  32); display.print((int)(yaw));
    //DX  display.setCursor(24, 32); display.print((int)(pitch));
    //DX   display.setCursor(48, 32); display.print((int)(roll));
    //DX   display.setCursor(66, 32); display.print("ypr");
    //DX
    //DX  display.setCursor(0, 40); display.print("rt: "); display.print(1.0f/deltat, 2); display.print(" Hz");
    //DX   display.display();
